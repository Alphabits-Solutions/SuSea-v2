...
const PLAYBOOKS = [
  {
    ...
    href: "/resources/playbook-7-questions-hiring-ai-agency.pdf",
    pages: "Free Download",
  },
  {
    icon: "rocket_launch",
    ...
    href: "/resources/playbook-vibe-code-to-production.pdf",
    pages: "Free Download",
  },
  {
    icon: "warning",
    ...
    href: "/resources/playbook-200k-ai-mistake-report.pdf",
    pages: "Free Download",
  },
  {
    icon: "calendar_month",
    ...
    href: "/resources/playbook-4-week-ai-mvp.pdf",
    pages: "Free Download",
  },
];
    ...
    <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
      ...
      <div className="space-y-6 mb-16 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-headline font-extrabold tracking-tighter text-on-surface">
          AI{" "}
          <span className="signature-text-gradient">Playbooks</span>
        </h1>
        <p className="text-xl text-on-surface-variant leading-relaxed max-w-2xl mx-auto">
          Opinionated, step-by-step guides for rolling out AI in your
          organisation — distilled from 200+ enterprise deployments across
          six industries. All free, no email wall.
        </p>
      </div>

      {/* Playbook cards */}
      <div className="grid md:grid-cols-2 gap-6 mb-20">
        {PLAYBOOKS.map(({ icon, tag, title, desc, href }) => (
          <a
            key={title}
            href={href}
            target="_blank"
            rel="noopener noreferrer"
            className="group glass-panel p-8 rounded-xl border border-outline-variant/15 relative overflow-hidden flex flex-col hover:border-primary/30 transition-colors"
          >
      ...
      <div className="bg-surface-container rounded-2xl p-10 md:p-16 border border-outline-variant/10 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto space-y-6">
          ...
          <p className="text-on-surface-variant">
            We&apos;re writing playbooks for HIPAA-safe AI, compliance-first FinTech, and scaling AI ops. Get notified when they drop.
          </p>
